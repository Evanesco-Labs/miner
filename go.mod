...
replace (
	...
	//github.com/ethereum/go-ethereum v1.10.6 => github.com/Evanesco-Labs/go-evanesco v0.0.0-20210812025646-d5acdd08ab7d
	github.com/ethereum/go-ethereum v1.10.6 => /Users/houmy/Documents/GoPro/src/go-evanesco
)
