...
require (
	github.com/Evanesco-Labs/go-evanesco v0.0.4-0.20211216072408-749a01f0d1e9
...
replace (
	github.com/Evanesco-Labs/go-evanesco v0.0.3-0.20211101055400-7db3305d0741 => github.com/Evanesco-Labs/go-evanesco v0.0.4-0.20211216072408-749a01f0d1e9
